...
// Creates Shader stages from the provided vert and frag ShaderModules
...
void PipelineBuilder::set_cull_mode(const VkCullModeFlags cullMode, const VkFrontFace frontFace)
{
    _rasterizer.cullMode = cullMode;
    _rasterizer.frontFace = frontFace;
}

void PipelineBuilder::set_multisampling_none() // TODO: MSAA
{
